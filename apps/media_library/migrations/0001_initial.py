    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(blank=True, max_length=255, verbose_name='credit / source')),
                ('is_decorative', models.BooleanField(default=False, help_text='Only for purely decorative images. Content images must describe themselves.', verbose_name='decorative (no alt text needed)')),
            ],
            options={
                'verbose_name': 'image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_private', models.BooleanField(default=False, help_text='Private documents are served only to logged-in CMS users.', verbose_name='private (consent forms etc.)')),
