...
T: dict[str, tuple[str, str]] = {
    ...
    # M4 — forms, tools, FAQ, feedback, glossary, directory
    "Spam check failed.": ("Spam tekshiruvi oʻtmadi.", "Проверка на спам не пройдена."),
    "Please confirm you are not a robot and try again.": (
        "Robot emasligingizni tasdiqlang va qayta urinib koʻring.",
        "Подтвердите, что вы не робот, и попробуйте снова.",
    ),
    "I agree to the processing of my data as described in the privacy policy": (
        "Maxfiylik siyosatida tavsiflanganidek, maʼlumotlarim qayta ishlanishiga roziman",
        "Я согласен(на) на обработку моих данных согласно политике конфиденциальности",
    ),
    "Your name (optional)": ("Ismingiz (ixtiyoriy)", "Ваше имя (необязательно)"),
    "Phone or e-mail (optional, for a private reply)": (
        "Telefon yoki e-mail (ixtiyoriy, shaxsiy javob uchun)",
        "Телефон или e-mail (необязательно, для личного ответа)",
    ),
    "Your question": ("Savolingiz", "Ваш вопрос"),
    "My question may be published anonymously with the answer": (
        "Savolim javob bilan birga anonim eʼlon qilinishi mumkin",
        "Мой вопрос можно опубликовать анонимно вместе с ответом",
    ),
    "Please describe your question in a few words.": (
        "Savolingizni bir necha soʻz bilan tasvirlang.",
        "Опишите ваш вопрос в нескольких словах.",
    ),
    "Other": ("Boshqa", "Другое"),
    "New": ("Yangi", "Новый"),
    "Answered (private)": ("Javob berilgan (shaxsiy)", "Отвечен (приватно)"),
    "Published": ("Eʼlon qilingan", "Опубликован"),
    "Rejected": ("Rad etilgan", "Отклонён"),
    "name (optional)": ("ism (ixtiyoriy)", "имя (необязательно)"),
    "contact (optional, encrypted)": (
        "aloqa (ixtiyoriy, shifrlangan)",
        "контакт (необязательно, зашифрован)",
    ),
    "Phone or e-mail. Encrypted at rest, deleted 90 days after the answer.": (
        "Telefon yoki e-mail. Shifrlangan holda saqlanadi, javobdan 90 kun oʻtgach oʻchiriladi.",
        "Телефон или e-mail. Хранится зашифрованным, удаляется через 90 дней после ответа.",
    ),
    "question": ("savol", "вопрос"),
    "may be published anonymously": (
        "anonim eʼlon qilinishi mumkin",
        "можно опубликовать анонимно",
    ),
    "language": ("til", "язык"),
    "question as published": ("eʼlon qilinadigan savol matni", "вопрос в опубликованном виде"),
    "Edited/anonymised wording shown on the site (empty = original text).": (
        "Saytda koʻrsatiladigan tahrirlangan/anonim matn (boʻsh = asl matn).",
        "Отредактированная/анонимная формулировка для сайта (пусто = исходный текст).",
    ),
    "answer": ("javob", "ответ"),
    "answered by": ("javob bergan", "ответил(а)"),
    "answered at": ("javob berilgan vaqt", "время ответа"),
    "published at": ("eʼlon qilingan vaqt", "время публикации"),
    "contact purged at": ("aloqa oʻchirilgan vaqt", "контакт удалён"),
    "Moderation": ("Moderatsiya", "Модерация"),
    "Submitted": ("Yuborilgan", "Отправлено"),
    "question to a doctor": ("shifokorga savol", "вопрос врачу"),
    "questions to a doctor": ("shifokorga savollar", "вопросы врачу"),
    "text above the form": ("forma ustidagi matn", "текст над формой"),
    "thank-you text": ("minnatdorchilik matni", "текст благодарности"),
    "questions & answers page": ("savol-javob sahifasi", "страница вопросов и ответов"),
    "What is it about?": ("Nima haqida?", "О чём сообщение?"),
    "Your message": ("Xabaringiz", "Ваше сообщение"),
    "Phone or e-mail (optional, if you want a reply)": (
        "Telefon yoki e-mail (ixtiyoriy, javob kerak boʻlsa)",
        "Телефон или e-mail (необязательно, если хотите ответ)",
    ),
    "Please write a few words.": ("Bir necha soʻz yozing.", "Напишите несколько слов."),
    "Feedback about the site": ("Sayt haqida fikr", "Отзыв о сайте"),
    "Something is broken": ("Nimadir ishlamayapti", "Что-то не работает"),
    "Partnership / volunteering": ("Hamkorlik / koʻngillilik", "Сотрудничество / волонтёрство"),
    "message": ("xabar", "сообщение"),
    "page": ("sahifa", "страница"),
    "browser": ("brauzer", "браузер"),
    "handled": ("koʻrib chiqilgan", "обработано"),
    "Submission": ("Murojaat", "Обращение"),
    "feedback submission": ("qayta aloqa xabari", "сообщение обратной связи"),
    "feedback submissions": ("qayta aloqa xabarlari", "сообщения обратной связи"),
    "feedback page": ("qayta aloqa sahifasi", "страница обратной связи"),
    "glossary page": ("lugʻat sahifasi", "страница словаря"),
    "Never": ("Hech qachon", "Никогда"),
    "Less than a year ago": ("Bir yildan kam vaqt oldin", "Меньше года назад"),
    "About a year ago": ("Taxminan bir yil oldin", "Около года назад"),
    "2 years ago": ("2 yil oldin", "2 года назад"),
    "3 years ago or more": ("3 yil va undan koʻp vaqt oldin", "3 года назад и более"),
    "Mammography": ("Mammografiya", "Маммография"),
    "Breast ultrasound": ("Koʻkrak UTT", "УЗИ молочных желёз"),
    "HPV test": ("HPV-test", "ВПЧ-тест"),
    "Your age": ("Yoshingiz", "Ваш возраст"),
    "Last %(test)s": ("Oxirgi %(test)s", "Последняя %(test)s"),
    "Tick everything you have noticed": (
        "Sezgan barcha belgilarni belgilang",
        "Отметьте всё, что вы заметили",
    ),
    "disclaimer": ("ogohlantirish", "дисклеймер"),
    "Empty = site setting.": ("Boʻsh = sayt sozlamasi.", "Пусто = настройка сайта."),
    "tools index page": ("asboblar sahifasi", "страница инструментов"),
    "text when a test is due": (
        "tekshiruv vaqti kelganda matn",
        "текст, когда обследование пора пройти",
    ),
    "text when tests are up to date": (
        "tekshiruvlar oʻz vaqtida boʻlsa matn",
        "текст, когда обследования актуальны",
    ),
    "text when no test applies at this age": (
        "bu yoshda tekshiruv tavsiya etilmasa matn",
        "текст, когда в этом возрасте обследование не показано",
    ),
    "HPV test interval note": (
        "HPV-test davriyligi haqida eslatma",
        "примечание об интервале ВПЧ-теста",
    ),
    "The TZ gives no interval for the HPV test — the doctor decides.": (
        "TZda HPV-test davriyligi koʻrsatilmagan — shifokor hal qiladi.",
        "В ТЗ интервал ВПЧ-теста не указан — решает врач.",
    ),
    "'where to go' page": ("«qayerga murojaat qilish» sahifasi", "страница «куда обратиться»"),
    "Result texts": ("Natija matnlari", "Тексты результата"),
    "screening helper page": ("skrining yordamchisi sahifasi", "страница помощника по скринингу"),
    "Sign / symptom": ("Belgi / simptom", "Признак / симптом"),
    "Urgency if ticked": ("Belgilansa shoshilinchlik", "Срочность, если отмечено"),
    "Women's symptom self-check": (
        "Ayollar uchun belgilarni oʻz-oʻzini tekshirish",
        "Самопроверка симптомов для женщин",
    ),
    "Warning signs in children (for parents)": (
        "Bolalardagi xavotirli belgilar (ota-onalar uchun)",
        "Тревожные признаки у детей (для родителей)",
    ),
    "checklist": ("roʻyxat", "чек-лист"),
    "checklist items": ("roʻyxat bandlari", "пункты чек-листа"),
    "result: nothing ticked": ("natija: hech narsa belgilanmagan", "результат: ничего не отмечено"),
    "result: routine": ("natija: odatiy", "результат: планово"),
    "result: soon": ("natija: tez orada", "результат: скоро"),
    "result: urgent": ("natija: shoshilinch", "результат: срочно"),
    "self-check page": ("oʻz-oʻzini tekshirish sahifasi", "страница самопроверки"),
    "Site sections": ("Sayt boʻlimlari", "Разделы сайта"),
    "Please correct the errors below.": ("Quyidagi xatolarni tuzating.", "Исправьте ошибки ниже."),
    "Loading…": ("Yuklanmoqda…", "Загрузка…"),
    "Map of institutions": ("Muassasalar xaritasi", "Карта учреждений"),
    "Thank you, your question has been sent.": (
        "Rahmat, savolingiz yuborildi.",
        "Спасибо, ваш вопрос отправлен.",
    ),
    "Ask a doctor": ("Shifokorga savol bering", "Спросить врача"),
    "We never publish names or contacts. Contacts are deleted 90 days after the answer.": (
        "Ism va aloqa maʼlumotlari hech qachon eʼlon qilinmaydi. Aloqa maʼlumotlari javobdan 90 kun oʻtgach oʻchiriladi.",
        "Мы никогда не публикуем имена и контакты. Контакты удаляются через 90 дней после ответа.",
    ),
    "Send question": ("Savolni yuborish", "Отправить вопрос"),
    "Answered questions": ("Javob berilgan savollar", "Отвеченные вопросы"),
    "Answered questions will appear here.": (
        "Javob berilgan savollar shu yerda paydo boʻladi.",
        "Здесь появятся отвеченные вопросы.",
    ),
    ...
    "Find a term": ("Atamani topish", "Найти термин"),
    "Letters": ("Harflar", "Буквы"),
    "No terms found.": ("Atamalar topilmadi.", "Термины не найдены."),
    "Your result": ("Sizning natijangiz", "Ваш результат"),
    "Not recommended at your age": (
        "Sizning yoshingizda tavsiya etilmaydi",
        "В вашем возрасте не рекомендуется",
    ),
    "Due now": ("Hozir oʻtish kerak", "Пора пройти"),
    "Done — ask your doctor when to repeat": (
        "Oʻtilgan — qachon takrorlashni shifokordan soʻrang",
        "Пройдено — когда повторить, уточните у врача",
    ),
    "Where to go": ("Qayerga murojaat qilish", "Куда обратиться"),
    "No warning signs ticked": (
        "Xavotirli belgilar belgilanmagan",
        "Тревожные признаки не отмечены",
    ),
    "%(checked)s of %(total)s ticked": (
        "%(total)s tadan %(checked)s tasi belgilangan",
        "отмечено %(checked)s из %(total)s",
    ),
    "Nothing you enter is stored.": (
        "Kiritgan maʼlumotlaringiz saqlanmaydi.",
        "Введённые данные не сохраняются.",
    ),
    "Check": ("Tekshirish", "Проверить"),
    "Show result": ("Natijani koʻrsatish", "Показать результат"),
    "Tools will appear here after medical sign-off.": (
...
P: dict[str, tuple[list[str], list[str]]] = {
    ...
    "Next in about %(years)s year": (
        ["Keyingisi taxminan %(years)s yildan keyin"],
        [
            "Следующее примерно через %(years)s год",
            "Следующее примерно через %(years)s года",
            "Следующее примерно через %(years)s лет",
        ],
    ),
    "every %(years)s year": (
        ["har %(years)s yilda"],
        ["раз в %(years)s год", "раз в %(years)s года", "раз в %(years)s лет"],
    ),
